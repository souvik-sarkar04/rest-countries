...
const CountryDetail = () => {
  // On clicking the card, actual details of the country ar eshown using this component
...
.get('name') extracts the value associated with the name key from the query string.
  */
  ...
  //its data as well as data of its border countries are also fetched.
    ...
    fetch(`https://restcountries.com/v3.1/name/${countryName}?fullText=true`)
      ...
      .then(async ([data]) => { //Array destructuring to get 1st name(array had only 1 element ccontaining all info of country)
        ...
        setCountryData({
          ...
          nativename: data.name ? Object.values(data.name)[0] : 'N/A', //optional chaining to get nativeName
          population: data.population,
          region: data.region,
          subregion: data.subregion ? data.subregion : 'N/A',
          capital: Object.values(data.capital)
            .join(', '),
          flag: data.flags.svg,
          tld: data.tld,
